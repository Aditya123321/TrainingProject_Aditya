	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-7 mar">
				...
				<hr class="co_line_short_hr">
				<br /> <span class="co_row_sp1"> Are you curious about
					something? Do you have some kind of problem with our<br />
					products? As am hastily invited setlled at limited civilly fortune
					me. Really spring in<br /> extent an by. Judge but guilt gay party
					world. Of so am he remember although<br /> required. Bachelor
					unpacked be advance at. Confined in declared marianne is<br />
					vicinity
				</span> <br /> <br /> <span class="co_row_sp2"> Please feel free to
					contact us, our customer service center is working for you 24/7 </span> <br />
				<h3>
					<b>CONTACT FORM</b>
				</h3>
				<hr class="co_line_short_hr">
				...
				<form action="contact" method="post">
					...
					<div class="row">
						<div class="col-md-10">
							Message:<br /> <input type="text" name="fname"
								class="co_input_textarea">

						</div>
					</div>
					<br /> <br />
					<div class="row">
						<button type="submit" class="btn btn-default co_button">
			...
			<div class="col-md-3">
				...
				<br />
				<br /> <span class="co_row_sp3"> TechAspect Solutions
					Pvt.Ltd.<br> Plot No. 38, N Heights, 3rd Floor<br> Hitech
					City Phase 2, Madhapur<br> Hyderabad, Telengana - 500081.<br>
					<b>India</b>.
				</span> <br> <br>
				<h4>
					<b>CALL CENTER</b>
				</h4>
				<br /> <span class="co_row_c2_sp4">This number is tollfree if
					calling from Great Britain<br> otherwise we would advise you
					to use electronic form of<br> communication
				</span> <br /> <br /> <b> +91 40 66217777 </b> <br /> <br />
				<h4>
				...
				<span>
					<ul class="co_row_bulletlist">
						<li>info@techaspect.com</li>
						<li>Tech 360 - our ticketing support platform</li>
					</ul>
				</span>
			</div>
		</div>
