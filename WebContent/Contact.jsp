	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-7 mar">
				...
				<br/>
				<span class="co_row_sp1">
					Are you curious about something? Do you have some kind of problem with our<br/>
					products? As am hastily invited setlled at limited civilly fortune me. Really spring in<br/>
					extent an by. Judge but guilt gay party world. Of so am he remember although<br/>
					required. Bachelor unpacked be advance at. Confined in declared marianne is<br/>
					vicinity
				</span>
				<br/>
				<br/>
				<span class="co_row_sp2">
				...
				<form action="contact" method="post">
					<div class="row">
						<div class="col-md-5">
						First Name:<br/>
						<input type="text" name="fname" class="co_input_text">
						</div>
						<div class="col-md-5">
						Last Name:<br/>
						<input type="text" name="lname" class="co_input_text">
						</div>					
					</div>
					<div class="row">
						<div class="col-md-5">
						Email:<br/>
						<input type="text" name="email" class="co_input_text">
						</div>
						<div class="col-md-5">
						Subject:<br/>
						<input type="text" name="subject" class="co_input_text">
						</div>					
					</div>
				<div class="row">
						<div class="col-md-10">
						Message:<br/>
						<input type="text" name="fname" class="co_input_textarea">
		...
		<div class="col-md-3">
			...
			<b>India</b>.</span>
			 ...
			 <h4><b>CALL CENTER</b></h4>
				...
				<span class="co_row_c2_sp4">This
				number is tollfree if calling from Great Britain<br> 
				otherwise we would advise you to use electronic form of<br>
				communication
				</span>
			<br/>
			 <br/>
			...
			<br/>
			<br/>
			<h4><b>ELECTRONIC SUPPORT</b></h4><br/>
