	...
	<div class="container-fluid">
		...
		<div class="row row3"
			...
			<div class="col-md-3 r3_c2">
				<span class="r3_c1_s">HOME</span>&nbsp; /&nbsp;MY ORDERS&nbsp;/&nbsp;ORDER DETAILS
			</div>
		</div>
		<!-- ROW 3 ENDS-->
		  ...
		  <br>
			...
			<div class="col-md-7">
				...
				<div id="od_table">
					...
					Akshat Kumar<br/>Plot No. 110, Road No.3<br/>Ajanta Homes<br/>Madinaguda<br/>Hyderabad - 500081<br/>Telangana, India
				...
				<div class="row">
					<div class="vertical-menu">
						<a href="#" ><span
							...
							href="#"><span class="glyphicon glyphicon-heart"></span>&nbsp;Order Details</a> <a href="#"><span class="glyphicon glyphicon-user"></span>&nbsp;My
							Account</a> <a href="#"><span class="glyphicon glyphicon-log-out"></span>&nbsp;Logout</a>
