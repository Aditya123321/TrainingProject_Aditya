	...
	<div class="container-fluid">
		...
		<div class="row row3"
			...
			<div class="col-md-3 r3_c2">
				<span class="r3_c1_s">HOME</span>&nbsp; /&nbsp;MY WISHLIST
			</div>
		</div>
		<!-- ROW 3 ENDS-->
		...
		<div class="col-md-2 mas" id="row4">
				...
				<div class="row">
					<div class="vertical-menu">
						<a href="#" >
						<span class="glyphicon glyphicon-list"></span>&nbsp;My Order</a> 
						<a href="#" class="active"><span class="glyphicon glyphicon-heart"></span>&nbsp;My
