	...
	<div class="container-fluid">
		...
		<div class="row row1">
			...
			<div class="col-md-2 r1_c2">
				<span class="glyphicon glyphicon-log-in"> SIGN IN&nbsp;</span> <span
		...
		<div class="row row3"
			...
			<div class="col-md-3 r3_c2">
				<span class="r3_c1_s">HOME</span>&nbsp; /&nbsp;EXCEPTION PAGE
			</div>
		</div>
		<!-- ROW 3 ENDS-->
		...
		<div class="row ep_row4">
			<div class="ep_box">
				<br />
				<p id="ep_box_p">
					<b>Sorry for Inconvenience - Page You are looking for have a
						Technical Error</b>
				</p>
				<br />
				<p class="ep_grey">
					<b>Kindly proceed to the Home Page or Report the issue to
						Website Administrator with the Description mentioned below.</b>
				</p>
				<br />
				<div class="col-md-6">
					<form action="index.jsp" method="post">
						<button type="submit" class="btn btn-default ep_sub4">
				...
				<div class="col-md-6">
					<form action="ExceptionSend" method="post">
						<button type="submit" class="btn btn-default ep_sub5">
				...
				<%String c=(String)session.getAttribute("ExceptionSent");
					...
					if(c.equals("1"))
					{
						%><div class="alert alert-success">Report has been sent
					successfully to the Administrator!</div>
				<%
					}
					else
					{
					%>
				<div class="alert alert-warning">Report could not be sent to
