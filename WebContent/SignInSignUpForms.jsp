	...
	<div class="container-fluid">
		...
		<div class="row row3"
			...
			<div class="col-md-3 r3_c2">
				<span class="r3_c1_s">HOME</span>&nbsp; /&nbsp;NEW ACCOUNT&nbsp;
				/&nbsp;SIGN IN
			</div>
		</div>
		<!-- ROW 3 ENDS-->
		...
		<div class="row mar">
			...
			<div class="col-md-6">
				...
				<p class="ssu_p_3">With registration with us new world of
					fashion,fantastic discounts and much more is open to you!The whole
					process will not take more than a minute.</p>
				<br>
				<br>
				<p class="ssu_p_4">If you have any queries feel free to contact
					us, out customer service is center is working 24/7</p>
			...
			<div class="col-md-6">
				...
				<p class="ssu_p_3">Get Access to your orders,whishlist and
					recommadations</p>
				<form action="login" method="post">
					...
					<br /> <input type="checkbox" value="yes" name="stayOn" />&nbsp;Stay
					Signed In <br />
					<button type="submit" class="btn btn-default ca_button">
