	...
	<div class="container-fluid">
		...
		<div class="row row3"
			...
			<div class="col-md-3 r3_c2">
				<span class="r3_c1_s">Home</span>&nbsp;/&nbsp;Electronics&nbsp;/&nbsp; Mobiles
				/&nbsp;CONTACT
			</div>
		</div>
		<!-- ROW 3 ENDS-->
		...
		<div class="row subp_row_mar"">
			<h4>
				<b>EXCLUSIVE OFFERS</b><br />
		...
		<div class="row subp_row_mar1">
			<div class="col-md-3">
				<img src="images/61b583.jpg" class="subp_img2" />
			</div>
			<div class="col-md-3">
				<img src="images/61b583.jpg" class="subp_img2" />
			</div>
		...
		<div class="row subp_row_mar2">
			<div class="card-deck">
				...
				<div class="col-md-2 hm_border1">
					<div class="card">
						<img class="card-img-top hr_card_img1 "
							src="images/nokia-6-1-na-original-imaf892exbgttdpe.jpeg">
						<div class="card-body hr_card_text">
		...
		<br />
		<div class="row ">
			<div class="col-md-3 subp_row_col_nomar">
				<h4>
					<b>Refine By</b><br />
					<hr class="co_line_short_hr">
				</h4>
		...
		<div class="row subp_row_mar">
			<div class="col-md-2 ">
				<div class="row subp_row_head">
					<h4>
						<b>Brand</b>
					</h4>
				</div>

				<div class="row subp_row_border">
					<div class="checkbox">
						<label><input type="checkbox" value="Samsung">Samsung</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="Vivo">Vivo</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="Oppo">Oppo</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="Motorola">Motorola</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="Nokia">Nokia</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="MI">MI</label><br />
					</div>
				</div>
			</div>
		...
		<div class="row subp_row_mar">
			<div class="col-md-2 ">
				...
				<div class="row subp_row_border">
					<div class="checkbox">
						<label><input type="checkbox" value="Samsung">Under
							₹1000</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="Vivo">₹1000-₹5000</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="Oppo">₹5000-₹10000</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="Motorola">₹10000-₹15000</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="Nokia">₹15000-₹20000</label><br />
					</div>
					<div class="checkbox">
						<label><input type="checkbox" value="MI">Above
							₹20000</label><br />
					</div>
				</div>
			</div>
