...
<body>
	<div class="container-fluid">
	 ...
	 <br />
		...
		<div class="row hm_r6">
			...
			<div class="card-deck">
				<div class="col-md-2 hm_border">
					<div class="card ">
						<img class="card-img-top hr_card_img"
							src="images/helkin-3-m-ss18-9-adidas-mysink-cblack-reagol-original-imaf2yznwyqzdzmd.jpeg">
				...
				<div class="col-md-2 hm_border1">
					<div class="card">
						<img class="card-img-top hr_card_img"
							src="images/rsc0274-10-red-tape-blue-original-imaextu5n84xxhsc.jpeg">
						<div class="card-body hr_card_text">
				...
				<div class="col-md-2 hm_border1">
					<div class="card">
						<img class="card-img-top  hr_card_img"
							src="images/tw00zr250-timex-original-imaf8wsejechwcfd.jpeg">
						<div class="card-body hr_card_text">
		...
		<div class="row">
			<div class="col-md-3 ">
				<img src="images/61b583.jpg" class="hm_img2" />
			</div>
			<div class="col-md-3 ">
				<img src="images/7194c7.jpg" class="hm_img2" />
			</div>
			<div class="col-md-3 ">
				<img src="images/1ee6febf917059b2.jpg" class="hm_img2" />
			</div>
			<div class="col-md-3">
				<img src="images/5b570b8a9bd0b179.jpg" class="hm_img2" />
			</div>
		...
		<div class="row hm_r6">
			...
			<div class="card-deck">
				...
				<div class="col-md-2 hm_border1">
					<div class="card">
						<img class="card-img-top  hr_card_img"
							src="images/ng3039sp01c-fastrack-original-imaev2thd4f837wk.jpeg">
						<div class="card-body hr_card_text">
				...
				<div class="col-md-2 hm_border1">
					<div class="card ">
						<img class="card-img-top hr_card_img"
							src="images/ng38022pp06cj-fastrack-original-imaetxgteqwhggpc.jpeg">
						<div class="card-body hr_card_text">
		...
		<div class="row row1">
			...
			<div class="col-md-3 cc">
				...
				<b>Join Our Monthly Newsletter</b><br> <input type ="text" class="def_text"><button class="button2 send"><span class="glyphicon glyphicon-send"></span></button>
				<br> <br>
			</div>
			<!-- COL1 ENDS -->
