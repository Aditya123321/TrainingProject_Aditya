...
public class CustomerService {
	...
	public boolean loginCustomer(Customer customer) {
		return (customerDao.selectCustomerEmailandPassword(customer));
	...
	public boolean getLastLoginUpdateService(Customer customer) throws UnsupportedEncodingException {
		boolean flag = false;

		flag = customerDao.getCookieCheckUpdate(customer);
		return flag;
	}

	public boolean insertCookieService(Customer customer) throws UnsupportedEncodingException {
		boolean flag = false;

		flag = customerDao.getAddCookieUpdate(customer);
		return flag;
	}
	...
	public boolean sendWelcomeMail(String name, String email) throws UnsupportedEncodingException {
		...
		try {
			...
			DataSource fds = new FileDataSource(
					"D://Trainee Engineers March 2019/workspace/TrainingProject_Aditya/WebContent/images/logo.png");
			...
			fds = new FileDataSource(
					"D://Trainee Engineers March 2019/workspace/TrainingProject_Aditya/WebContent/images/welcome.jpg");
			mbp1.setDataHandler(new DataHandler(fds));
	...
	public boolean sendUpdatePasswordMail(String name, String email) throws UnsupportedEncodingException {
		...
		try {
			...
			mbp1 = new MimeBodyPart();
			DataSource fds = new FileDataSource(
					"D://Trainee Engineers March 2019/workspace/TrainingProject_Aditya/WebContent/images/update.jfif");
			mbp1.setDataHandler(new DataHandler(fds));
			mbp1.setHeader("Content-ID", "<image>");
			mp.addBodyPart(mbp1);
	...
	public boolean sendExceptionSendMail(String name, String s) throws UnsupportedEncodingException {
		...
		try {
			...
			String msg = "<body bgcolor='white'><i><font color='blue'>Dear Developer</font></i>,<br/><br/>"
					+ "<font color='red'>The following Exception has been encountered by one of the customers while surfing the web application.Please rectify it as soon as possible.<br/>"
					+ s
					+ "<br/>This is an auto generated email, please do not reply back.<br/> For further queries contact the customer care center.</font></h2>"
